...
class _OwnerProfileState extends State<OwnerProfile> {
      ...
      if (data != null) {
        ...
        if (mounted) {
          setState(() {
            ...
            address = gymData?['address'] as String? ?? 'Add your gym address';
            phone = data['phone'] as String? ?? 'Add phone number';
            posterUrl = gymData?['posterUrl'] as String?;
            avatarUrl = gymData?['avatarUrl'] as String?;
            _loading = false;
          });
        }
      }
  ...
  void _showEditProfile() {
    final nameCtrl = TextEditingController(text: gymName);
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 24),
                _editField(nameCtrl, 'Gym Name', Icons.storefront_rounded),
                const SizedBox(height: 14),
                _editField(addrCtrl, 'Address', Icons.location_on_rounded),
            ...
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  const SizedBox(height: 12),
                  _infoBox(Icons.location_on_rounded, 'Address', address),
                ],
              ),
            ),
